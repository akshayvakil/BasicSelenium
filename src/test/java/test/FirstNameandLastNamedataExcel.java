...
import utils.ExcelDataProviderUtil;


public class FirstNameandLastNamedataExcel {
    ...
    public Object [] [] provideData() {
		/*
		 * return new Object[][]{ {"Sidharth", "Shukla"}, {"John", "Doe"}, {"Jane",
		 * "Smith"}, {"Michael", "Johnson"} // Add more test data as needed };
		 */
    	try {
			return ExcelDataProviderUtil.readTestDataFromExcel("D:\\Users\\AKSHAY\\new-eclipse-workspace\\TestAkshaySeleniumProject\\src\\main\\resources\\testData.xlsx");
		} catch (IOException e) {
			System.out.println("Check excel file created for data provider");
		} 
		return null;
    }
